// Ported from AnymeX (MIT License)
// https://github.com/RyanYuuki/AnymeX/blob/main/lib/widgets/non_widgets/snackbar.dart
...
void errorSnackBar(
  ...
  showSnackBar(
    ...
    iconColor: const Color(0xFFA63344),
...
class _SnackBarWidgetState extends State<_SnackBarWidget>
  ...
  void initState() {
    ...
    _slideAnimation =
        Tween<double>(begin: 1.0, end: 0.0).animate(entryCurve);
  ...
  Color get _accentColor => const Color(0xFFA63344);
  Color get _bgColor =>
            ...
            child: Align(
              ...
              child: Padding(
                ...
                child: AnimatedContainer(
                  ...
                  child: Opacity(
                    opacity:
                        (_fadeAnimation.value * _swipeFadeOpacity)
                            .clamp(0.0, 1.0),
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              BoxShadow(
                color: const Color(0xFFA63344).withValues(alpha: 0.06),
                blurRadius: 12,
                ...
                Text(
                  ...
                  style: widget.theme.textTheme.bodySmall?.copyWith(
                    color: cs.onSurface.withValues(
                        alpha: widget.title != null ? 0.65 : 0.85),
                    height: 1.4,
                  ),
                ),
              ],
    ...
    return AnimatedBuilder(
      ...
      builder: (_, b) {
        return SizedBox(
          ...
          child: Stack(
            children: [
              Container(color: _accentColor.withValues(alpha: 0.08)),
